...
import Sunbase.example.Project.models.JwtRequest;
import Sunbase.example.Project.models.JwtResponse;
import Sunbase.example.Project.security.JwtHelper;
...
public class AuthController {
    ...
    public ResponseEntity login(@RequestBody JwtRequest request) {
        ...
        try{
            //given function will do the Authentication..
